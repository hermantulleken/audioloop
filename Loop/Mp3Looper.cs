...
public class Mp3Looper : AudioLooper<Mp3WaveFormat>
{
	private const int Max16BitInt = 32768;
	private const float Max16BitIntAsFloat = Max16BitInt;
	
	protected override void Save(string outputPath, float[] trimmedData, Mp3WaveFormat waveFormat)
	{
	...
	protected override (float[], Mp3WaveFormat) Load(string inputMp3File)
	{
